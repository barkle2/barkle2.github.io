...
![응용: 책 목록 데이터베이스]({{ site.url }}/assets/img/SQL_project1.png)
...
![응용: 박스오피스 흥행작 데이터베이스]({{ site.url }}/assets/img/SQL_project2.png)
<img src="{{ site.url }}/assets/img/SQL_project2.png" alt="응용: 박스오피스 흥행작 데이터베이스">
</details>  
<details>
<summary>응용: 데이터베이스의 통계</summary>

![응용: 데이터베이스의 통계]({{ site.url }}/assets/img/SQL_project3.png)
</details>  
<details>
<summary>프로젝트: 가게 데이터베이스 만들기</summary>

![프로젝트: 가게 데이터베이스 만들기]({{ site.url }}/assets/img/SQL_project4.png)
</details>  
