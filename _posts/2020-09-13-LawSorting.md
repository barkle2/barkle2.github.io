...
- 그런데 결과가 좀 이상합니다. 법률이 총 1,910건이나 검색되었습니다.
...
- 우선 1,910건의 검색화면 오른쪽 위쪽에 있는 목록저장 버튼을 눌러 법률 목록을 엑셀 파일로 저장합니다.
...
- [중복제거 1] 법령명이 동일한 행을 제거
  ...
  - '법령명' 열을 중복 값이 있는 열로 선택하고 [확인] 버튼을 누르면 368개의 중복된 행이 제거되고, 1,542건의 법률이 남습니다.
...
- 1,496건은 법제처 법령통계의 숫자와 같지만, 문제가 하나 있습니다. [중복제거 1] 과정에서 제정 법률이 삭제될 수 있기 때문에, [중복제거 1]보다 [중복제거 2]를 먼저 해야 합니다.
  ...
  - 그 다음에 [중복제거 1]을 하면 362건이 법률이 삭제됩니다.
...
- 이번 글은 여기까지입니다.
  - 이 글의 내용을 통해 단순한 통계지만 꽤 여러 단계를 거쳐 만들어진다는 것, 통계를 생산하려면 처음에는 생각하지 못했던 질문들에 대한 답을 찾아야만 신뢰할 수 있는 통계를 만들 수 있다는 것을 여러분과 공유할 수 있으면 좋겠습니다.
